...
public class BuffBarraPequena extends BuffGenerico
{
    public BuffBarraPequena(int x, int y, ModeloDaltonicos mDalt, ModeloNivel mNivel)
    {
    ...
    public void ejecutarAccion() {
        if(!mNivel.getBuffTamanoBarra())
        {
            ...
            Image scaleImage = barra.getImage().getScaledInstance(barra.getIconWidth()/2, barra.getIconHeight(), Image.SCALE_DEFAULT);
